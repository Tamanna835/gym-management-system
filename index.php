...
<body>
    ...
    <select name="schedule_id" class="goal" required>
        <option value="" disabled selected>Select your workout time</option>
 ...
 if ($_SERVER["REQUEST_METHOD"] == "POST") { 
    ...
    if ($result->num_rows > 0) {
        ...
        (name, email, phone, dob, goal, schedule_id, accepted_terms)
        VALUES ('$name', '$email', '$phone', '$dob', '$goal', '$schedule_id', '$terms')";
